  ...
  return (
    <div className="max-w-6xl mx-auto md:p-0 pt-10">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-lg text-black mt-2">Share your thoughts below</p>
      </div>
      ...
      <div className="flex justify-center mb-6">
        <Button
          ...
          type="none"
          className="text-white py-5 px-6 font-semibold hover:border-gray-100 bg-green-600 hover:bg-green-500"
        >
          Add Comment
        </Button>
      </div>
      ...
      <Modal
        ...
        open={showModal} // Use `open` instead of `visible`
        width={350}
